...
<style scoped>
    .Habbo-Selection-List {
        border-image: url(./../../static/images/select_menu.png) 2 2 2 2 fill;
    ...
    .Habbo-Selection-List .Habbo-Selection-List__Arrow {
        width: 14px;
        height: 16px;
        background-image: url(./../../static/images/select_menu_arrow.png);
        top: 0px;
        right: 5px;
        position: absolute;
    }
    ...
    .Habbo-Selection-List .Habbo-Selection-List__Item-List {
        ...
        padding-top: 2px;
        padding-bottom: 2px;
        border-image: url(./../../static/images/select_menu.png) 2 2 3 2 fill;
        border-left: 2px solid transparent;
