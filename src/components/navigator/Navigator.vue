<template>
    <window :id="3" :width="panel ? '578px' : '425px'" height="535px" :title="isLoading ? __locale('navigator.title.is.busy') : __locale('navigator.title')" @close="close" resizable-y draggable>
