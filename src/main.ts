...
import UserCount from './components/windows/navigator/UserCount.vue';
import Renderer from './components/Renderer.vue';
import Game from './views/Game.vue';
import Loading from './views/Loading.vue';
import LandingView from './components/landing-view/LandingView.vue';
import RoomInfoThumbnail from './components/windows/navigator/RoomInfoThumbnail.vue';
import RoomThumbnail from './components/windows/navigator/RoomThumbnail.vue';
...
app.component('room-info-thumbnail', RoomInfoThumbnail);
app.component('room-thumbnail', RoomThumbnail);
